...
namespace Triqui
{
    class Program
    {
        ...
        public static void IngresarJugadores()
        {
            ...
            Console.WriteLine("Ingrese el número del jugaro número 1: ");
            jugador1 = Console.ReadLine();
            Console.WriteLine("Ingrese el número del jugaro número 2: ");
        ...
        private static void ComprobarEstadoDelJuego()
        {
            ...
            if (partidaGanada)
            {
                ...
                Console.ForegroundColor = ConsoleColor.Green;
                if (jugadorActual == 1)
                    Console.WriteLine($"¡Felicidades {jugador1} eres el ganador!");
                else
                    Console.WriteLine($"¡Felicidades {jugador2} eres el ganador!");
                terminado = true;
            }
